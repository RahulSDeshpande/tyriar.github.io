...
var tagNames = [".NET","ASP.NET","Accessibility","Algorithm","Amazon","Android","Artificial intelligence","Bash","Behavioural design pattern","Blogging","C#","CSS","Canvas","Chrome","Computer science","Concurrency","Creational design pattern","Dart","Data structure","Debugging","Design","Design pattern","Entity framework","Extension method","Firefox","Generics","Git","GitHub","Google","Graph","HTML","Hotkey","IIS","Internet Explorer","Interview questions","Java","JavaScript","Jekyll","jQuery","Knockout","LESS","LINQ","MVC","Markdown","Math","Microsoft","My projects","Natural language","Opera","Optimisation","Pathfinding","Prettyprint","Productivity","Razor","Reflection","Responsive web design","SASS","SEO","SQL","SVG","Safari","Search engine","Searching","Software engineering","Sorting","Stack Exchange","Structural design pattern","Sublime Text","Testing","Tree","UML","Umbraco","Visual Studio","Windows"];
(function () {
